...
namespace vk
{
    ...
    {
        {
        	...
        	//per-object textures
        	InitializeTextureSamplerDescriptor();
	...
	/*void DeferredContext::InitializeTextureSamplerDescriptor()
	{
    	std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings(PBR_COUNT);

    	for (size_t i = 0; i < setLayoutBindings.size(); ++i)
    	{
    		setLayoutBindings[0].binding = static_cast<uint32_t>(i);
    		setLayoutBindings[0].descriptorCount = 1;
    		setLayoutBindings[0].descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    		setLayoutBindings[0].stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
    	}

    	vk::DescriptorBufferCreateInfo descriptorBufferCI = {};
    	...
    	//textureSamplerDescriptor.Create(descriptorBufferCI);
    }

	void DeferredContext::InitializeCompositionSamplerDescriptor()
    {
    	//+1 for shadow sampling
    	std::array<VkDescriptorSetLayoutBinding, RT_COUNT + 1> setLayoutBindings = {};
    	...
    	//compositionSamplerDescriptor.Create(descriptorBufferCI);
    }
	...
	void DeferredContext::InitializeSwapChainDescriptor()
	{
    	...
    	//swapChainSamplerDescriptor.Create(descriptorBufferCI);
    }
	...
	void DeferredContext::InitializeSkyBoxDescriptor()
	{
    	...
    	//skyboxSamplerDescriptor.Create(descriptorBufferCI);
    }*/
}