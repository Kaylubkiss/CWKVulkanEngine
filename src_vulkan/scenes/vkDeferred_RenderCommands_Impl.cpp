...
namespace vk
{
    void DeferredContext::RecordCommandBuffers( Scene& scene )
	{
		...
		/*{
			...
			drawInfo.textureLayoutSize = textureSamplerDescriptor.GetLayoutSize();
		...
		//Composition
		{
			...
			descriptor_buffer_binding_info[0].sType = VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_INFO_EXT;
			descriptor_buffer_binding_info[0].address =
				compositionSamplerDescriptor.GetBuffer().GetDeviceAddress();
			...
			//image sampler set 0;
			VkDeviceSize buffer_offset = currentFrame * compositionSamplerDescriptor.GetLayoutSize();
		...
		/#1#/Skybox.
		{
			...
			descriptor_buffer_binding_info[1].sType = VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_INFO_EXT;
			descriptor_buffer_binding_info[1].address =
				skyboxSamplerDescriptor.GetBuffer().GetDeviceAddress();
			descriptor_buffer_binding_info[1].usage = VK_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT |
				VK_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT;
		...
		//Swapchain Quad
		{
			...
			descriptor_buffer_binding_info[0].sType = VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_INFO_EXT;
			descriptor_buffer_binding_info[0].address =
				swapChainSamplerDescriptor.GetBuffer().GetDeviceAddress();
			descriptor_buffer_binding_info[0].usage = VK_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT |
				VK_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT;
			...
			VkDeviceSize buffer_offset = currentFrame * swapChainSamplerDescriptor.GetLayoutSize();
